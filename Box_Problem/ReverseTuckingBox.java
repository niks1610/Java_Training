class ReverseTuckingBox implements Box{
    private String type;
    ...
    public ReverseTuckingBox(String type,double length,double width,double height,Flute flute)
    {
    ...
    {
        return type+" ReverseTucking "+length+" "+width+" "+height;
    }
}
