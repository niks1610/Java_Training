class AllFlapMeetingBox implements Box{
    private String type;
    ...
    public AllFlapMeetingBox(String type,double length,double width,double height,Flute flute)
    {
    ...
    {
        return type+" AllFlapMeeting "+length+" "+width+" "+height;
    }
}
