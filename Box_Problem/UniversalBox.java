class UniversalBox implements Box{
    ...
    public UniversalBox(String type,double length,double width,double height,Flute flute)
    {
    ...
    {
        return type+" UniversalBox "+length+" "+width+" "+height;
    }
}
