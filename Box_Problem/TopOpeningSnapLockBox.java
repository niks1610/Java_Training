class TopOpeningSnapLockBox implements Box{
    private String type;
    ...
    public TopOpeningSnapLockBox(String type,double length,double width,double height,Flute flute)
    {
    ...
    {
        return type+" TopOpeningSnapLock "+length+" "+width+" "+height;
    }
}
